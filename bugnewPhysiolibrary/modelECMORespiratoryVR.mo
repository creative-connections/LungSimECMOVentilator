...
package modelECMORespiratoryVR
  ...
  equation
    ...
    connect(conductor.q_out, Tissue.heatPort) annotation (Line(
        points={{-172,-340},{-170,-340},{-170,-258},{-180,-258},{-180,-254}},
        color={191,0,0},
        thickness=0.5));
  ...
  equation
    ...
    connect(body.q_out,lungs1.q_in              [1]) annotation (Line(
        points={{-79.7902,-17.1024},{-76,-17.1024},{-76,45.8824},{-69.8194,
            45.8824}},
        color={127,0,0},
        thickness=0.5));
    connect(shunt.q_out,lungs1.q_in1    [1]) annotation (Line(
        points={{-44,12},{-24.9161,12},{-24.9161,43.6471}},
        color={127,0,0},
        thickness=0.5));
    connect(body.q_in,lungs1.q_in1         [2]) annotation (Line(
        points={{-27.6492,-17.7171},{-24,-17.7171},{-24,14},{-24.9161,14},{
            -24.9161,43.6471}},
        color={127,0,0},
        thickness=0.5));
    connect(lungs1.q_in       [2], shunt.q_in) annotation (Line(
        points={{-69.8194,45.8824},{-76,45.8824},{-76,12},{-64,12}},
        color={127,0,0},
        thickness=0.5));
  ...
  model Lungs
    ...
    Physiolibrary.Fluid.Interfaces.FluidPorts_a q_in(redeclare package Medium =
          Blood) annotation (Placement(transformation(rotation=0, extent={{-85.5,-77},
              {-26.5,-43}}), iconTransformation(extent={{-85.5,-77},{-26.5,-43}})));
    Physiolibrary.Fluid.Interfaces.FluidPorts_a q_in1(redeclare package Medium =
          Blood) annotation (Placement(transformation(rotation=0, extent={{-5.5,-81},
              {53.5,-47}}), iconTransformation(extent={{-5.5,-81},{53.5,-47}})));
  equation
    connect(flowMeasureAlveols.q_in,Alveoly. q_in[1]) annotation (Line(
    ...
    connect(ventilatorGas.y,DeadSpace. q_in) annotation (Line(
        ...
        color={127,0,0},
        thickness=0.5));
    connect(q_in, LungsArteries.q_in) annotation (Line(points={{-56,-60},{-56,-128},
            {-237.1,-128}},color={127,0,0}));
    connect(q_in1, LungsVeins.q_in) annotation (Line(points={{24,-64},{147.1,-64},
            {147.1,-150},{147.1,-130}}, color={127,0,0}));
